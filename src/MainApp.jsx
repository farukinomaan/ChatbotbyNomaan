...
//                   key={chat.id}
//                   onClick={() => setSelectedChatId(chat.id)}
//                   className={`p-3 rounded-lg cursor-pointer transition-all duration-200 ${selectedChatId === chat.id
//                     ? 'bg-gradient-to-r from-blue-700 to-purple-700 shadow-lg transform scale-[1.02]'
//                     : 'hover:bg-gradient-to-r hover:from-zinc-700 hover:to-slate-700 hover:shadow-md hover:scale-[1.01]'
//                     } border border-transparent ${selectedChatId === chat.id ? 'border-blue-500/30' : 'hover:border-zinc-600/30'}`}
//                 >
...
//               <div className="bg-gradient-to-r from-zinc-800/50 to-slate-800/50 rounded-lg p-3 mb-3 border border-zinc-700/30">
//                 <p className="text-sm text-zinc-300 mb-2">Logged in as:</p>
//                 <p className="text-sm font-medium text-zinc-200 truncate">{user.email}</p>
//               </div>
//               <button
//                 onClick={signOut}
//                 className="w-full px-4 py-2 bg-gradient-to-r from-red-600 to-pink-600 rounded-lg hover:from-red-500 hover:to-pink-500 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105 font-medium"
//               >
//                 Sign Out
//               </button>
//             </div>
...
//                 <h3 className="text-xl font-semibold text-zinc-300 mb-2">Welcome to Chatbot</h3>
//                 <p className="text-zinc-500">Select a chat to start messaging or create a new one</p>
//               </div>
//             </div>
//           )}
//         </div>
