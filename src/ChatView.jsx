...
//                                 <div
//                                     className={`p-3 rounded-2xl max-w-[75%] relative ${isCurrentUser
//                                             ? 'bg-gradient-to-r from-blue-600 to-blue-500 text-white rounded-br-md shadow-lg'
//                                             : isBot
//                                                 ? 'bg-gradient-to-r from-zinc-700 to-slate-700 text-zinc-100 rounded-bl-md shadow-lg border border-zinc-600/30'
//                                                 : 'bg-gradient-to-r from-zinc-800 to-slate-800 text-zinc-200 rounded-bl-md shadow-lg'
//                                         }`}
//                                 >
//                                     {/* Message content */}
//                                     <p className="text-sm leading-relaxed">{msg.content}</p>
...
//             {/* Input */}
//             <div className="border-t border-zinc-800/50 bg-gradient-to-r from-zinc-800/50 to-slate-800/50 p-4 backdrop-blur-sm">
...
//                         onChange={(e) => setMessageContent(e.target.value)}
//                         placeholder="Type a message..."
//                         className="flex-1 px-4 py-3 bg-gradient-to-r from-zinc-800 to-slate-800 border border-zinc-700/50 rounded-2xl focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-transparent text-zinc-100 placeholder-zinc-400 shadow-inner"
//                         disabled={sendingMessage}
//                     />
//                     <button
//                         type="submit"
//                         className="px-6 py-3 bg-gradient-to-r from-purple-800 to-pink-800 hover:from-purple-700 hover:to-pink-700 disabled:from-purple-600 disabled:to-pink-600 text-white rounded-2xl transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105 disabled:scale-100 font-medium min-w-[80px]"
//                         disabled={sendingMessage || !messageContent.trim()}
//                     >
//                         {sendingMessage ? (
//                             <div className="flex items-center justify-center">
